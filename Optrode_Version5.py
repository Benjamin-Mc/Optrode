...
def DAQ_Read_Process(Number_of_DAC_Samples):
    ...
    '''
    while DAQ_Index[0] < Number_of_DAC_Samples:
...
def Power_Read_Process(number_of_power_samples):
    ...
    '''
    while Power_Index[0] < number_of_power_samples:
...
def Spectrometer_Read_Process(Number_of_Spectrometer_Samples):
    ...
    while (I < Number_of_Spectrometer_Samples):
        #Last_Spec_Record[:] = Current_Spec_Record[:]
        #Current_Spec_Record[:], Spec_Time[Spectrometer_Index[0]] = Spec1.readIntensity(True, True)
        a,b = Spec1.readIntensity(True, True)
        Full_Spec_Records2[Spectrometer_Index[0]*Wave_len : (Spectrometer_Index[0] + 1)*Wave_len] = a[Min_Wave_Index:Max_Wave_Index]
...
def Perform_Test():
    ...
    while True:
        ...
        if Power_meter.Error == 0:
            ...
            Power_Signal = Array('d', np.zeros(shape=(number_of_power_samples, 1), dtype=float))
            Power_Time = Array('d', np.zeros(shape=(number_of_power_samples, 1), dtype=float))
